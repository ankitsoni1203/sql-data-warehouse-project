...
begin
    ...
    begin try 
        ...
        truncate table bronze.crm_cust_info -- no duplicate data by multiple insert 
        ...
        truncate table bronze.crm_prd_info -- no duplicate data by multiple insert 
        ...
        truncate table bronze.crm_sales_details -- no duplicate data by multiple insert 
        ...
        truncate table bronze.erp_cust_az12-- no duplicate data by multiple inserts 
        ...
        truncate table bronze.erp_loc_a101-- no duplicate data by multiple inserts 
        ...
        truncate table bronze.erp_px_cat_g1v2-- no duplicate data by multiple insert 
